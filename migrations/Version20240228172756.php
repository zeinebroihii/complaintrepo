 ...
 */
final class Version20240228172756 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE complaint_response (id INT AUTO_INCREMENT NOT NULL, id_complaint_id INT NOT NULL, date DATETIME DEFAULT NULL, response VARCHAR(255) NOT NULL, INDEX IDX_22622279CE6F6DFC (id_complaint_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
