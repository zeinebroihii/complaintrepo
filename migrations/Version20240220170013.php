 ...
 */
final class Version20240220170013 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE complaint (id INT AUTO_INCREMENT NOT NULL, id_user_id INT DEFAULT NULL, date DATE DEFAULT NULL, type VARCHAR(10) NOT NULL, description VARCHAR(255) NOT NULL, status VARCHAR(255) DEFAULT NULL, priority INT NOT NULL, INDEX IDX_5F2732B579F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE response (id INT AUTO_INCREMENT NOT NULL, id_complaint_id INT NOT NULL, date DATE NOT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_3E7B0BFBCE6F6DFC (id_complaint_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
